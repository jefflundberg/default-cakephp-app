...
<div class="col col-md-9">
	...
	<?php echo "<?php echo \$this->Form->create('{$modelClass}', array('role' => 'form', 'class' => 'form-horizontal', 'inputDefaults' => array('div' => 'form-group', 'label' => array('class' => 'col col-md-3 control-label'), 'wrapInput' => 'col col-md-9', 'class' => 'form-control'))); ?>\n"; ?>
			<fieldset>
...
<div class="col col-md-3">
	<div class="actions well col col-md-12">
